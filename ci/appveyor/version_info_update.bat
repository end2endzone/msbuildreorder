...
echo Updating %OUTPUTFILE%...
echo #ifndef MSBUILDREORDER_VERSION_H>%OUTPUTFILE%
echo #define MSBUILDREORDER_VERSION_H>>%OUTPUTFILE%
echo #define MSBUILDREORDER_VERSION "%APPVEYOR_BUILD_VERSION%">>%OUTPUTFILE%
echo #endif //MSBUILDREORDER_VERSION_H>>%OUTPUTFILE%
set OUTPUTFILE=
echo done.
echo.
